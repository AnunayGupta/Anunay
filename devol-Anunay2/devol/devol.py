...
class DEvol:
    ...
    def run(self, dataset, num_generations, pop_size, epochs, fitness=None,
        ...
        if len(dataset) == 2:
            self.train_gen, self.test_gen = dataset
            self.x_val = None
            self.y_val = None
        else:
            self.train_gen, self.test_gen, self.val_gen = dataset
    ...
    def _evaluate(self, genome, epochs):
        ...
        fit_params = {
            ...
            'steps_per_epoch': 870/16,
            'validation_steps': 218/16,
            'callbacks': [
        ...
        try:
            ...
            loss, accuracy = model.evaluate_generator(self.test_gen, 218/16)
